...
bigList = Arrays.stream(files)
    ...
    .collect(Collectors.toList());
        ...
        System.out.println("letterCount:" + letterToCount.toString());

        System.out.println("distinct words:");
        Files.lines(Paths.get("./test_data/essay.txt"))
                .map(line -> line.split("\\s+")) // Stream<String[]>
                .flatMap(Arrays::stream) // Stream<String>
                .distinct() // Stream<String>
                .forEach(System.out::println);

        String dataFile = "./test_data/data.txt";
    ...
    public static void functions() throws IOException {
        // 1. Integer Stream
        IntStream
                .range(1, 10)
        ...
        List<String> bands2 = Files.lines(Paths.get("test_date/bands.txt"))
