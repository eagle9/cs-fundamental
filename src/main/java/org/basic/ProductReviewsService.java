...
/*
Key point of this demo, multiple threads can hold readLock if there is no writing
boost read performance 3 or more times when read is often
while keep read and write data consistency, so smart
 */
